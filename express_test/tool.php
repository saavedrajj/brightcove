...
$a= gmdate("Y-m-d\TH:i:s\Z");
$b= gmdate("Y-m-d\TH:i:s\Z",strtotime('-150 minutes'));  
?>
  ...
  <div class="container">
    ...
    <form action="results.php" method="post" target="_blank">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="from" name="from" placeholder="Initial date" value="<?php echo $b;?>">
        <small id="fromHelp" class="form-text text-muted">Date format: 2018-09-24T16:00:00Z</small>
      </div>
      <div class="form-group">
        <label for="toLabel">To</label>
        <input type="text" class="form-control" id="to" name="to"placeholder="Final date"value="<?php echo $a;?>">
