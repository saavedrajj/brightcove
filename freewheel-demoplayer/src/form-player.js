...
tv.freewheel.DemoPlayer.prototype = {
  requestAds: function() {
    ...
    var formSiteSectionFallbackId = document.getElementById('siteSectionFallbackID').value;
    ...
    if (this.siteSectionFallbackId !== "") {
      this.siteSectionFallbackId = formSiteSectionFallbackId;
    }
    ...
    */
    ...
    if (this.siteSectionFallbackId !== "") {
      this.currentAdContext.siteSectionFallbackId(this.siteSectionFallbackId, this.networkId);
    }
